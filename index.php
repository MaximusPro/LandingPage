...
?>
    ...
    <div class="form-group">
        <input type="email" name="email" placeholder="Quantum Channel (Email)" required>
    </div>
    <div class="form-group">
        <input type="text" name="subject" placeholder="Mission Objective (Subject)" required>
    </div>
    <div class="form-group">
        <textarea name="message" rows="5" placeholder="Transmission Data (Message)" required></textarea>
    </div>
